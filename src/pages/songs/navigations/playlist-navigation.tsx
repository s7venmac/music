            ...
            <TouchableOpacity
              ...
              onPress={() => {
                musicContext
                  ...
                  .then(playlist => {
                    toast(`Tạo playlist ${playlist.name} thành công .`);
                  })
                  .catch(playlist => {
                    toast(`${playlist} Đã tồn tại.`);
                  });
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    musicContext
                      ...
                      .catch(() => {
                        toast('Không thể xoá danh sách này.');
                      });
                  }}>
                  <Trash2
                    strokeWidth={3}
                    ...
                    if (value.musics.length) {
                      TrackPlayer.setQueue(value.musics).then(() =>
                        TrackPlayer.play().then(() => {
                          ...
                          toast(`Phát playlist ${value.name}.`);
                        }),
                      );
                    } else {
                      toast('playlist trống.');
                    }
                  }}>
                  <ListVideo
                    strokeWidth={3}
              ...
              <Song.Root
                ...
                <TouchableOpacity
                  onPress={() => {
                    ...
                    toast(`${music.title} loại bỏ ${selectPlaylist.name}`);
                  }}
                  activeOpacity={0.5}>
                  <Trash2
                    strokeWidth={3}
